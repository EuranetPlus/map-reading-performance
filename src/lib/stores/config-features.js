export const config = {
	mapTitle: 'reading-perfomance', // The title of the map, if more than one word, separate by dash, e.g. "income-europe"
	vercelURL: 'https://map-reading-performance.vercel.app/', // The url provided when deploying the map on Vercel
